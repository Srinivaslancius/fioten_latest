...
<!-- Page Title Here -->
<title>Fioten :: Banking Information</title>
<!-- Mobile Specific -->
    ...
    <div class="page-content">
        ...
        <div class="w3-bnr-inr overlay-black-middle" style="background-image:url(images/background/bg3.jpg);">
            <div class="container">
                <div class="w3-bnr-inr-entry">
                    <h1 class="text-white">Banking Information</h1>
                </div>
            </div>
        </div>
        ...
        <div class="content">
			...
			<div class="section-full content-inner bg-white">
				<div class="container">
					<div class="row">
                                            <div class="icon-bx-wraper bx-style-1 p-a30 center m-b15 col-md-5">
                                                <div class="icon-bx-sm text-primary bg-white radius border-2 m-b20"> <a href="#" class="icon-cell"><i class="fa fa-bank"></i></a> </div>
                                                <div class="icon-content">
                                                    <h5 class="w3-tilte text-uppercase">Bank Details 1</h5>
                                                    <div class="col-md-12">
                                                        <div class="col-md-5">
                                                        <p>
                                                            Company Name
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="col-md-6">
                                                        <p>
                                                            111,East Wisconsin Avenue, milwaukee, WI, 53202, USA
                                                        </p>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                            ...
                                            <div class="col-md-7">
                                                ...
                                                <ul class="list-check-circle primary">
                                                    <li>Only Wire or Banker's check</li>
                                                    <li>No Cash transactions</li>
                                                    <li>Delivery process for banker's checks starts upon confirmation of fund transfer </li>
